...
class TestDomainGenerator:
    ...
    def test_is_valid_domain_name(self):
        ...
        for domain in valid_domains:
            assert self.generator._is_valid_domain_name(domain), f"Should be valid: {domain}"
        
        for domain in invalid_domains:
            assert not self.generator._is_valid_domain_name(domain), f"Should be invalid: {domain}"
